...
public class Start {
	public static void main(String[] args) {
		...
		/**
		 * 	PERGUNTA PARA O USUÁRIO O TAMANHO DO ARRAY;
		 */
		try {
		...
		/**
		 *  ESTRUTURA DE REPETIÇÃO PARA POPULAR OS ÍNDICES DO ARRAY, PERGUNTANDO PARA O
	    ...
	    for (int i = 0; i < numbers.size(); i++) {
	    	...
	    	/**
	    	 * 	SOMANDO OS NÚMEROS LOCALIZADOS A FRENTE DO ÍNDICE ATUAL;
	    	 */
	    	if (i == (numbers.size() - 1)) {
	    		sumRight = 0;
